...
import {titleTextColor, mainBackgroundColor, mainColor} from "../../constraint/Colors";
        ...
        let showView = (
            <LFlatList
                ...
                renderItem={({item, index}) =>
                    <View key={index} style={{backgroundColor: 'white', width:deviceWidth, marginLeft:10, marginTop:5, marginBottom: 5, borderRadius: 3,  overflow:'hidden'}}>
                        <TouchableOpacity
                            activeOpacity={0.7}
