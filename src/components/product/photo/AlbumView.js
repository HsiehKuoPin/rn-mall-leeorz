...
import {StyleSheet, View, Image, Animated, ViewPropTypes, Text} from 'react-native';
...
export default class AlbumView extends Component {
  ...
  render() {
    ...
    if (React.isValidElement(control)) {
      ...
      control = <View style={{position: 'absolute',
          left: 0,
          right: 0,
          bottom: 0,
          padding: 4,
          alignItems: 'center',}}>
        <Text style={{color:'white'}}>{this.state.index + 1}/{images.length}</Text>
      </View>
    }
